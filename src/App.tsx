          ...
          <div className="wiki-card">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="wiki-card">
                ...
                <p className="section-text">Interesting facts and recent discoveries...</p>
              </div>
            </div>
          </div>
        </main>
      ...
      <footer className="bg-white dark:bg-gray-900 border-t border-wiki-border mt-8">
        <div className="container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="section-title">Perplexipedia</h3>
              <p className="section-text">
                An AI-powered encyclopedia for the modern age.
              </p>
            </div>
            <div>
              <h3 className="section-title">Community</h3>
              <ul className="space-y-1">
                <li><a href="#" className="nav-link text-sm">Portal</a></li>
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li><a href="#" className="nav-link text-sm">Edit Articles</a></li>
                <li><a href="#" className="nav-link text-sm">Create Page</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li><a href="#" className="nav-link text-sm">Terms of Use</a></li>
              </ul>
            </div>
          </div>
        </div>
